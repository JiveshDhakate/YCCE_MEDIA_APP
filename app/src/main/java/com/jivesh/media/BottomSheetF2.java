...
public class BottomSheetF2 extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        cardView = view.findViewById(R.id.related_f2_cv);
        cardView2 = view.findViewById(R.id.your_notification_f2_cv);
        ...
        cardView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity(),YourNotifications.class));
