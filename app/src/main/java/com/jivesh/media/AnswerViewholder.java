...
public class AnswerViewholder extends RecyclerView.ViewHolder{
    ...
    public void setAnswer(Application application,String name,String answer, String uid, String time , String  url){
        ...
        imageView = itemView.findViewById(R.id.iv_ans);
        nameTv = itemView.findViewById(R.id.tv_ans_name);
        timeTv = itemView.findViewById(R.id.tv_ans_time);
    ...
    public void  upvoteChecker(String postkey){
        ...
        votesnoTv = itemView.findViewById(R.id.tv_vote_no_ans);
